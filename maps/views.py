...
#     survey_result = json.loads(request.GET['survey_result'])
    ...
    attractions = {'a': attr_info('chick-fil-a', 'westwood'), 'b': attr_info('chick-fil-a', 'westwood'), 'c': attr_info('chick-fil-a', 'westwood'), 'd': attr_info('chick-fil-a', 'westwood'), 'e': attr_info('chick-fil-a', 'westwood'), 'f': attr_info('chick-fil-a', 'westwood'), 'g': attr_info('chick-fil-a', 'westwood'), 'h': attr_info('chick-fil-a', 'westwood'), 'i': attr_info('chick-fil-a', 'westwood'), 'j': attr_info('chick-fil-a', 'westwood'), 'k': attr_info('chick-fil-a', 'westwood'), 'l': attr_info('chick-fil-a', 'westwood')}
